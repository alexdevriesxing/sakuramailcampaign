...
import { renderContacts, renderFiles, saveContact } from './dashboard-audience.js';
...
async function switchView(view) {
  ...
  try {
    const renderers = { overview: renderOverview, campaigns: renderCampaigns, contacts: renderContacts, files: renderFiles, billing: renderBilling, settings: renderSettings, admin: renderAdmin };
